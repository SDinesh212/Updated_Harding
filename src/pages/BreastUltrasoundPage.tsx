...
const heroStats = [
  { icon: Waves, title: "3D Ultrasound", text: "Advanced screening" },
...
const overviewItems = [
  ...
  "Radiation-free ultrasound imaging.",
  "Helps provide additional breast tissue detail.",
  "Comfortable, non-invasive imaging experience.",
];

const serviceCards = [
  {
    icon: Waves,
    title: "What Is 3D Breast Ultrasound?",
    text: "3D breast ultrasound uses sound waves to create detailed breast tissue images without radiation.",
  },
  {
    icon: UserRoundCheck,
    title: "Who Should Consider This Exam?",
    text: "It may be recommended for patients with dense breast tissue or those needing supplemental screening.",
  },
  {
    icon: FileText,
    title: "What To Expect During Your Exam",
    text: "The exam is comfortable and non-invasive while advanced imaging captures breast tissue detail.",
  },
];
...
const whyCards = [
  {
    ...
    text: "Uses ultrasound sound waves instead of radiation.",
  },
  {
    icon: BadgeCheck,
    title: "Dense Breast Support",
    text: "Helpful as a supplemental screening tool.",
  },
  {
    icon: Clock3,
    title: "Quick Appointment",
    text: "Efficient scan process with minimal wait time.",
  },
  {
    icon: HeartPulse,
...
export default function BreastUltrasoundPage() {
  return (
      ...
      <main className="relative">
          ...
          <div className="relative mx-auto grid h-full max-w-7xl items-center gap-8 pb-8 lg:grid-cols-[0.9fr_1fr] lg:gap-12">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-600">
                3D breast ultrasound provides supplemental, radiation-free
                imaging for breast tissue evaluation, helping support confident
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="relative rounded-[48px] border border-emerald-300/60 bg-white/70 p-4 shadow-2xl shadow-emerald-900/15 backdrop-blur">
                <img
                  ...
                  alt="3D breast ultrasound machine"
        ...
        <section className="service-overflow-curve relative z-10 mt-[calc(100vh-1.5rem)] rounded-t-[54px] bg-white px-5 py-24 shadow-[0_-30px_80px_rgba(5,47,53,0.08)] lg:px-10">
          ...
          >
            ...
            <img
              src="/images/breast-ultrasound-machine.jpg"
            ...
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black text-[#062f35] sm:text-5xl">
                Whole Breast{" "}
                <span className="text-emerald-600">Ultrasound</span>
              </h2>

              <p className="mt-5 text-base leading-8 text-slate-600">
                SOFIA 3D Whole Breast Ultrasound provides supplemental imaging
                for dense breast tissue using sound waves. It can help doctors
                evaluate breast tissue with additional clarity and confidence.
              </p>
              ...
              <div className="mt-8 rounded-3xl bg-gradient-to-r from-emerald-50 to-teal-50 p-6 text-sm font-bold leading-7 text-emerald-700">
                3D breast ultrasound can be a helpful supplemental screening
                option for patients with dense breast tissue.
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 bg-[#f4fffb] px-5 py-24 lg:px-10">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600">
              A safe, proactive, and painless way to add more detail to breast
              screening without radiation.
            </p>
          ...
          <div className="mx-auto grid max-w-6xl items-center overflow-hidden rounded-[42px] bg-gradient-to-r from-[#effaf6] to-[#dff7ee] shadow-2xl shadow-emerald-900/10 lg:grid-cols-[1fr_0.9fr]">
            <div className="p-8 sm:p-12">
              ...
              <h2 className="mt-4 max-w-xl text-3xl font-black leading-tight text-[#062f35] sm:text-4xl">
                Schedule Your 3D Breast Ultrasound Today
              </h2>

              <p className="mt-5 max-w-lg text-sm leading-7 text-slate-600">
                Call us now or book online for supplemental breast imaging with
                comfort, clarity, and expert care.
              </p>
            ...
            <div className="relative h-[360px]">
              ...
              <img
                ...
                alt="Doctor for 3D breast ultrasound"
