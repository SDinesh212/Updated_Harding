...
const heroStats = [
  { icon: HeartPulse, title: "Heart Screening", text: "Calcium scoring" },
  { icon: ScanLine, title: "CT Imaging", text: "Precise scan" },
  { icon: Clock3, title: "Quick Exam", text: "Fast appointment" },
  { icon: UserRoundCheck, title: "Expert Review", text: "Trusted care" },
];

const overviewItems = [
  "Checks for calcium buildup in coronary arteries.",
  "Helps estimate risk of coronary artery disease.",
  "Quick, non-invasive CT-based heart screening.",
...
const serviceCards = [
  {
    ...
    text: "Cardiac calcium scoring helps evaluate plaque buildup in coronary arteries and supports early heart disease risk assessment.",
  },
  {
    icon: ScanLine,
    title: "How Does It Work?",
    text: "A CT scan captures detailed images of the heart to measure calcium deposits in the coronary arteries.",
  },
  {
    icon: FileText,
    title: "Who Should Consider This Test?",
    text: "It may be recommended for adults with risk factors such as family history, high cholesterol, diabetes, or smoking history.",
  },
];
...
const whyCards = [
  {
    ...
    text: "Helps detect heart disease risk before symptoms appear.",
  },
  {
    icon: BadgeCheck,
    title: "Accurate Scoring",
    text: "Provides a calcium score to support care decisions.",
  },
  {
    icon: Clock3,
    title: "Quick Appointment",
    text: "Fast, non-invasive scan with minimal wait time.",
  },
  {
    icon: HeartPulse,
    title: "Heart Health",
    text: "Supports proactive cardiac care and prevention.",
  },
];

export default function CardiacScoringPage() {
  return (
    <div className="isolate min-h-screen overflow-x-hidden bg-white text-[#073b3a]">
      ...
      <main className="relative">
          ...
          <div className="relative mx-auto grid h-full max-w-7xl items-center gap-8 pb-8 lg:grid-cols-[0.9fr_1fr] lg:gap-12">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-600">
                A coronary artery calcium score uses CT imaging to check for
                calcium buildup in the heart arteries, helping estimate heart
                disease risk and support preventive care planning.
              </p>
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="service-float relative rounded-[48px] border border-emerald-300/60 bg-white/70 p-4 shadow-2xl shadow-emerald-900/15 backdrop-blur">
                <img
                  src="/images/cardiac-scoring-hero.jpg"
                  alt="Cardiac calcium scoring CT scan"
        ...
        <section className="service-overflow-curve relative z-10 mt-[calc(100vh-1.5rem)] rounded-t-[54px] bg-white px-5 py-24 shadow-[0_-30px_80px_rgba(5,47,53,0.08)] lg:px-10">
          ...
          >
            <img
              src="/images/cardiac-scoring-scan.jpg"
              alt="Cardiac calcium score CT images"
            ...
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black text-[#062f35] sm:text-5xl">
                ...
                <span className="text-emerald-600">Scoring CT?</span>
              </h2>

              <p className="mt-5 text-base leading-8 text-slate-600">
                Coronary artery calcium scoring is a CT scan that measures
                calcium buildup in the coronary arteries. Your calcium score can
                help estimate your risk for heart disease and guide preventive
                care decisions.
              </p>
              ...
              <div className="mt-8 rounded-3xl bg-gradient-to-r from-emerald-50 to-teal-50 p-6 text-sm font-bold leading-7 text-emerald-700">
                Cardiac calcium scoring can help detect hidden heart disease
                risk and support timely preventive care.
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 bg-[#f4fffb] px-5 py-24 lg:px-10">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600">
              A simple, non-invasive CT scan that helps evaluate heart disease
          ...
          <div className="mx-auto grid max-w-6xl items-center overflow-hidden rounded-[42px] bg-gradient-to-r from-[#effaf6] to-[#dff7ee] shadow-2xl shadow-emerald-900/10 lg:grid-cols-[1fr_0.9fr]">
            <div className="p-8 sm:p-12">
              ...
              <h2 className="mt-4 max-w-xl text-3xl font-black leading-tight text-[#062f35] sm:text-4xl">
                Schedule Your Cardiac Calcium Scoring CT
              </h2>

              <p className="mt-5 max-w-lg text-sm leading-7 text-slate-600">
                Call us now or book online for preventive heart screening with
                advanced CT imaging and expert radiology care.
              </p>
            ...
            <div className="relative h-[360px]">
              ...
              <img
                src="/images/cardiac-scoring-doctor.png"
                alt="Doctor reviewing cardiac CT scan"
