...
const heroStats = [
  { icon: ShieldCheck, title: "Low Radiation", text: "Safe exposure" },
  { icon: ScanLine, title: "Digital X-Ray", text: "Clear imaging" },
  { icon: Clock3, title: "Fast Results", text: "Quick diagnosis" },
  { icon: UserRoundCheck, title: "Expert Team", text: "Certified care" },
];

const overviewItems = [
  "Quick and painless diagnostic scan.",
  "Useful for bones, chest, lungs, and joints.",
  "Digital imaging with high clarity.",
  "Safe procedure with low radiation dose.",
];
...
const serviceCards = [
  {
    ...
    text: "Advanced X-ray technology captures clear internal images for accurate medical evaluation.",
  },
  {
    icon: Bone,
    title: "Bone & Joint Care",
    text: "Helpful for detecting fractures, injuries, arthritis, and other bone-related conditions.",
  },
  {
    icon: Activity,
    title: "Chest & Body X-Ray",
    text: "Supports diagnosis of chest, lung, abdomen, and soft tissue conditions quickly.",
  },
];
...
const whyCards = [
  {
    ...
    text: "Low-dose imaging designed with patient safety and comfort in mind.",
  },
  {
    icon: Clock3,
    title: "Quick Appointment",
    text: "Fast scan process with smooth scheduling and minimal waiting.",
  },
  {
    icon: ScanLine,
    title: "Clear Images",
    text: "Modern digital systems provide sharp diagnostic image quality.",
  },
  {
    icon: UserRoundCheck,
    title: "Expert Review",
    text: "Images are reviewed by experienced radiology professionals.",
  },
];
          ...
          <div className="relative mx-auto grid h-full max-w-7xl items-center gap-8 pb-8 lg:grid-cols-[0.9fr_1fr] lg:gap-12">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-600">
                Our digital X-ray service provides fast, safe, and high-quality
                imaging to help doctors diagnose injuries, infections, bone
                conditions, and chest-related concerns with confidence.
              </p>
        ...
        <section className="service-overflow-curve relative z-10 mt-[calc(100vh-1.5rem)] rounded-t-[54px] bg-white px-5 py-24 shadow-[0_-30px_80px_rgba(5,47,53,0.08)] lg:px-10">
          ...
          >
            <img
              ...
              alt="Patient receiving X-ray scan"
              className="h-[460px] w-full rounded-[42px] object-cover shadow-2xl shadow-emerald-900/10"
            />
            ...
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black text-[#062f35] sm:text-5xl">
                What Is A Routine{" "}
                <span className="text-emerald-600">X-Ray?</span>
              </h2>

              <p className="mt-5 text-base leading-8 text-slate-600">
                A routine X-ray uses a small amount of radiation to create
                images of the inside of the body. It is one of the most common
                and effective ways to detect a wide range of medical conditions.
              </p>
        ...
        <section className="relative z-10 bg-[#f4fffb] px-5 py-24 lg:px-10">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-black text-[#062f35] sm:text-4xl">
              Clear Imaging. Comfortable Experience.
            </h2>
          ...
          <div className="mx-auto grid max-w-6xl items-center overflow-hidden rounded-[42px] bg-gradient-to-r from-[#effaf6] to-[#dff7ee] shadow-2xl shadow-emerald-900/10 lg:grid-cols-[1fr_0.9fr]">
            <div className="p-8 sm:p-12">
              ...
              <p className="mt-5 max-w-lg text-sm leading-7 text-slate-600">
                Fast scheduling, comfortable imaging, and reliable diagnostic
                support from an experienced radiology team.
              </p>
