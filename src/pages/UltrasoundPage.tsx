...
const heroStats = [
  { icon: ShieldCheck, title: "Radiation-Free", text: "Safe imaging" },
  { icon: Waves, title: "Real-Time Scan", text: "Live imaging" },
  { icon: Clock3, title: "Fast Results", text: "Quick diagnosis" },
  { icon: UserRoundCheck, title: "Expert Team", text: "Certified care" },
];

const overviewItems = [
  "Safe and radiation-free diagnostic imaging.",
  "Useful for abdomen, pelvis, vascular, and soft tissue exams.",
  "Real-time imaging for organs, tissues, and blood flow.",
  "Comfortable, non-invasive, and widely used procedure.",
];
...
const serviceCards = [
  {
    ...
    text: "Ultrasound uses sound waves to create live images of organs, tissues, blood flow, and pregnancy development.",
  },
  {
    icon: HeartPulse,
    title: "Vascular & Doppler",
    text: "Color and Doppler imaging help evaluate blood flow and vascular conditions with clarity.",
  },
  {
    icon: Baby,
    title: "Pregnancy Imaging",
    text: "Safe imaging support for pregnancy monitoring and women’s health examinations.",
  },
  {
    icon: Activity,
    title: "Abdominal Studies",
    text: "Helpful for evaluating liver, kidneys, gallbladder, pancreas, spleen, and related concerns.",
  },
];
...
const whyCards = [
  {
    ...
    text: "Ultrasound does not use ionizing radiation, making it safe for many patients.",
  },
  {
    icon: Clock3,
    title: "Quick Appointment",
    text: "Efficient scan process with smooth scheduling and minimal wait time.",
  },
  {
    icon: ScanLine,
    title: "Clear Imaging",
    text: "Advanced ultrasound technology provides detailed real-time images.",
  },
  {
    icon: UserRoundCheck,
    title: "Expert Review",
    text: "Your exam is performed and reviewed by experienced imaging professionals.",
  },
];
          ...
          <div className="relative mx-auto grid h-full max-w-7xl items-center gap-8 pb-8 lg:grid-cols-[0.9fr_1fr] lg:gap-12">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-600">
                Our advanced ultrasound technology delivers clear, real-time
                images in a safe, radiation-free environment, helping physicians
                evaluate organs, tissues, and blood flow with accuracy and
                comfort.
              </p>
          ...
          >
            ...
            <div>
              ...
              <p className="mt-5 text-base leading-8 text-slate-600">
                Our GE LOGIQ ultrasound system delivers high-quality imaging
                with advanced color and Doppler capabilities, providing clear
                visualization of organs, soft tissues, and blood flow for
                accurate, real-time, non-invasive evaluations.
              </p>
              ...
              <div className="mt-8 rounded-3xl bg-gradient-to-r from-emerald-50 to-teal-50 p-6 text-sm font-bold leading-7 text-emerald-700">
                Our ultrasound technology delivers clear results in a safe,
                comfortable, radiation-free experience.
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 bg-[#f4fffb] px-5 py-24 lg:px-10">
          <div className="mx-auto max-w-6xl">
            <div className="text-center">
              <span className="text-xs font-black uppercase tracking-[0.25em] text-emerald-600">
                Understanding Your Examination
              </span>

              <h2 className="mt-4 text-3xl font-black text-[#062f35] sm:text-4xl">
                Safe Diagnostic Imaging Without Radiation
              </h2>

              <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600">
                Learn how ultrasound evaluates organs, tissues, blood flow, and
                pregnancy safely and comfortably.
              </p>
            </div>
            ...
            <div className="mt-10 rounded-[34px] bg-white p-8 shadow-xl shadow-emerald-900/5">
              <h3 className="text-2xl font-black text-[#062f35]">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {examTypes.map((exam) => (
                  <div
                    key={exam}
                    className="flex items-center gap-3 rounded-2xl bg-[#f4fffb] px-4 py-3 text-sm font-bold text-slate-600"
                  >
          ...
          <div className="mx-auto grid max-w-6xl items-center overflow-hidden rounded-[42px] bg-gradient-to-r from-[#effaf6] to-[#dff7ee] shadow-2xl shadow-emerald-900/10 lg:grid-cols-[1fr_0.9fr]">
            <div className="p-8 sm:p-12">
              ...
              <p className="mt-5 max-w-lg text-sm leading-7 text-slate-600">
                Call us now or book online for quick scheduling, expert care,
