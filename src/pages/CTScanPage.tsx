...
const heroStats = [
  { icon: ScanLine, title: "High Precision", text: "Detailed CT images" },
  { icon: ShieldCheck, title: "Low-Dose CT", text: "Safer imaging" },
  { icon: Clock3, title: "Fast Exam", text: "Quick appointment" },
  { icon: UserRoundCheck, title: "Expert Review", text: "Trusted care" },
];

const overviewItems = [
  "High-resolution imaging for detailed diagnosis.",
  "Useful for chest, abdomen, pelvis, spine, and vascular exams.",
  "Supports lung screening, cardiac calcium scoring, and urgent studies.",
  "Fast, accurate imaging with expert interpretation.",
];
...
const serviceCards = [
  {
    ...
    text: "A CT scan uses advanced X-ray technology and computer processing to create detailed cross-sectional images of the body.",
  },
  {
    icon: UserRoundCheck,
    title: "Who Should Have A CT Scan?",
    text: "CT scans may be recommended for patients who need detailed evaluation of organs, bones, vessels, or internal conditions.",
  },
  {
    icon: FileText,
    title: "What To Expect During Your Exam",
    text: "The scan is usually quick and painless. You lie comfortably on a table while the scanner captures detailed images.",
  },
];
...
const whyCards = [
  {
    ...
    text: "Modern CT technology supports detailed imaging with optimized radiation dose.",
  },
  {
    icon: BadgeCheck,
    title: "Accurate Results",
    text: "Detailed cross-sectional views help doctors diagnose with confidence.",
  },
  {
    icon: Clock3,
  ...
  },
  {
    icon: HeartPulse,
    title: "Advanced Care",
    text: "Supports cardiac, lung, vascular, and emergency diagnostic needs.",
  },
];
          ...
          <div className="relative mx-auto grid h-full max-w-7xl items-center gap-8 pb-8 lg:grid-cols-[0.9fr_1fr] lg:gap-12">
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-600">
                CT imaging provides detailed cross-sectional views of the body,
                helping physicians evaluate organs, bones, blood vessels, and
                soft tissues with speed, clarity, and confidence.
              </p>
          ...
          >
            ...
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black text-[#062f35] sm:text-5xl">
                A New Standard In{" "}
                <span className="text-emerald-600">CT Imaging</span>
              </h2>

              <p className="mt-5 text-base leading-8 text-slate-600">
                CT imaging uses advanced X-ray technology to create detailed
                images of internal structures. It can help evaluate injuries,
                infections, lung conditions, calcium scoring, vascular concerns,
              ...
              <div className="mt-8 rounded-3xl bg-gradient-to-r from-emerald-50 to-teal-50 p-6 text-sm font-bold leading-7 text-emerald-700">
                CT imaging supports fast diagnostic answers with clear,
                high-detail results for confident care planning.
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="relative z-10 bg-[#f4fffb] px-5 py-24 lg:px-10">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-black text-[#062f35] sm:text-4xl">
              Clear Diagnostic Imaging For Fast Medical Answers
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600">
              CT scans help doctors see detailed cross-sectional images to
          ...
          <div className="mx-auto grid max-w-6xl items-center overflow-hidden rounded-[42px] bg-gradient-to-r from-[#effaf6] to-[#dff7ee] shadow-2xl shadow-emerald-900/10 lg:grid-cols-[1fr_0.9fr]">
            <div className="p-8 sm:p-12">
              ...
              <h2 className="mt-4 max-w-xl text-3xl font-black leading-tight text-[#062f35] sm:text-4xl">
                Schedule Your CT Scan Appointment Today
              </h2>

              <p className="mt-5 max-w-lg text-sm leading-7 text-slate-600">
                Call us now or book online for quick scheduling, advanced CT
                imaging, and expert diagnostic care.
              </p>
